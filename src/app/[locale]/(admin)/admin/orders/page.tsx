    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-base sm:text-xl text-gray-500 dark:text-muted-foreground mt-1">{t('subtitle')}</p>
        </div>
      </div>
                   ...
                   <tr key={order.orderId || order._id} className="group hover:bg-gray-50 dark:hover:bg-muted/30 transition-colors">
                     ...
                     <td className="px-6 py-4">
                       <div className="flex items-center gap-3">
                         ...
                         <div>
                           <div className="font-medium text-gray-900 dark:text-foreground text-base sm:text-xl">{order.customer?.name || 'Guest User'}</div>
